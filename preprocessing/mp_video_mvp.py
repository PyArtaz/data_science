...
# MediaPipe demo: Capture video from connected camera, print some results to the console and save the annotated video.

# Specify with which probability the detected landmarks are printed to the console
print_probability = 0.0025
# Specify whether video should be saved or not. It will be saved to the same folder as this script named 'output.avi'.
save_video = False
