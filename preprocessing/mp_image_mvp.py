...
# MediaPipe demo: Load image(s), print some results to the console and save the annotated image(s).

# Insert (relative) file path(s) of the image(s) to be processed
IMAGE_FILES = ['../data_science/dataset/test/5_35_2_cam1.png']
# Specify path of the annotated images
annotated_img_path = '../data_science/dataset/test/evaluation'
