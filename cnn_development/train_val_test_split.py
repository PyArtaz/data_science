...
input_folder = '../dataset/digits'
output = '../dataset/digits_split'  # where you want the split datasets saved. one will be created if it does not exist or none is set
